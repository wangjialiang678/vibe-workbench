...
- [local-mac] 本地监听器 HTTP 拉取/领取/续租/完成、codex/claude/notify 分流、单并发、优雅下线、launchd 配置
...
| 本地监听器 | tests/unit/local-listener.test.mjs | 配置、codex/claude/notify 分流、claim/renew/complete 序列、CLI 启动失败、单并发与优雅下线 | [local-mac] |
