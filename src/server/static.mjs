...
const ASSET_VERSION_FILES = ['render/index.html', 'render/app.mjs', 'render/app.css', 'render/theme.css', 'render/blocks.mjs', 'render/readonly-view.mjs', 'render/vendor/mermaid.min.js'];
